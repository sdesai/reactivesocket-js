...
ReactiveClient.prototype._conEstablished = function _conEstablished(opts) {
    ...
    var self = this;
    this._stream.write(setupFrame, function(err) {
    ...
    this._stream.on('data', function(rawData) {
 ...
 * @param {Object} data -
 * @param {Object} data.data - The data to be sent
 * @param {Object} data.meta - The meta to be sent
